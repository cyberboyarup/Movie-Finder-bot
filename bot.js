const token = '5405149769:AAFzV8PtPURRshtyXy0uzrYwYwF_bsPssrA';
...
bot.onText(/\/search (.+)/, function(msg,match) {
  ...
  request('https://www.omdbapi.com/?t=' + movie + '&apikey=ffe404d6', function(error,response,body) {
...
bot.onText(/\/Donate/, function(msg,match) {
    var chatId = msg.chat.id;
    bot.sendMessage(chatId, '🎬 *Movie Finder* is a bot for Telegram developed by Arup Mandal.  \n  \nThis Is Free Platfrom You Can Find Movie Detils By Simply Typing Movie Name.\n \nIf Possibale Give Littile Contribute By Clicking *Donate Now*.', {parse_mode:'Markdown',
      reply_markup: JSON.stringify({
        inline_keyboard: [
